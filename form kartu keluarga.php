<?php 
include_once('kartu_keluarga_mail.php');
?>
...
<html lang="en">
  <head>
    ...
    <title>Permohonan Kartu Keluarga</title>
  ...
  <body>
    ...
    <div class="container" style="background-color: rgb(212, 208, 208)">
      <br />
      <h1 style="text-align: center">PERMOHONAN PEMBUATAN ATAU PERUBAHAN KARTU KELUARGA</h1>
      <div class="row">
        <div class="col-xl-6 col-sm-12" style="padding: 10px">
          ...
          <form method="post" enctype="multipart/form-data">
            ...
            <div class="row" style="margin-top: 10px">
              <div class="col-xl-6 col-sm-12" style="width: 200px; margin-left: 20px">
                <p>ALAMAT KETERANGAN PERUBAHAN KK</p>
              </div>
              <div class="col-xl-6 col-sm-12">
                <div
                  style="
            ...
            <div style="margin-left: auto; width: auto; text-align: center">
              <input
                type="submit"
                name="submit"
        ...
        <div class="col-xl-6 col-sm-12">
          ...
          >
            ...
            <ol>
              ...
              <li>Scan File Kartu Keluarga Lama (ASLI)</li>
            </ol>
            ...
            <ol>
              ...
              <li>Tuliskan keterangan perubahan yang yang akan dirubah pada KK. Jika pembuatan KK baru silahkan tuliskan<b>PEMBUATAN KK BARU</b></li>
