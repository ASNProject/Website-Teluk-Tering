...
if (isset($_POST["submit"])){
    ...
    $path3 = 'upload/' . $_FILES["kklama"]["name"];
    move_uploaded_file($_FILES["kklama"]["tmp_name"], $path3);
    $message = '
    <h3 align="center">Permohonan Kartu Keluarga</h3>
...
// ADD YOUR DETAILS HERE
    ...
    $mail->Subject = 'Permohonan Kartu Keluarga';                //Sets the Subject of the message
