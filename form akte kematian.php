<?php 
include_once('akte_kematian_mail.php');
?>
...
<html lang="en">
  <head>
    ...
    <title>Permohonan Akte Kematian</title>
  ...
  <body>
    ...
    <div class="container" style="background-color: rgb(212, 208, 208)">
      <br />
      <h1 style="text-align: center">PERMOHONAN AKTE KEMATIAN</h1>
      <div class="row">
        <div class="col-xl-6 col-sm-12" style="padding: 10px">
          ...
          <form method="post" enctype="multipart/form-data">
            ...
            <div style="margin-left: auto; margin-right=20px; width: auto; text-align: center">
              <input
                type="submit"
                name="submit"
        ...
        <div class="col-xl-6 col-sm-12">
          ...
          >
            ...
            <ol>
              ...
              <li>Scan Surat Kematian</li>
              <li>Scan Akte Nikah (Jika Ada)</li>
              <li>Scan Surat Nikah (Jika Ada)</li>
              <li>Scan Surat Pemakaman</li>
              <li>Scan KTP Pelapor</li>
            </ol>
            ...
            <div style="margin-right: auto; width: auto; margin-left: auto; text-align: center">
              <input
                type="submit"
                name="submit"
                value="GRATIS"
