<?php 
include_once('pindah_masuk_mail.php');
?>
...
<html lang="en">
  <head>
    ...
    <title>Permohonan Pindah Masuk</title>
  ...
  <body>
    ...
    <div class="container" style="background-color: rgb(212, 208, 208)">
      <br />
      <h1 style="text-align: center">PERMOHONAN SURAT PINDAH MASUK</h1>
      <div class="row">
        ...
        <div class="col-xl-6 col-sm-12">
          ...
          >
            <p>Persyaratan</p>
            <ol>
              <li>Scan Pengantar RT dan RW Tempat Asal(ASLI)</li>
              <li>Scan Pengantar RT dan RW Tempat Pindah Baru</li>
