...
if (isset($_POST["submit"])){
    ...
    $path2 = 'upload/' . $_FILES["pengantar2"]["name"];
    move_uploaded_file($_FILES["pengantar2"]["tmp_name"], $path2);
    $path3 = 'upload/' . $_FILES["ktp"]["name"];
    move_uploaded_file($_FILES["ktp"]["tmp_name"], $path3);
    $path4 = 'upload/' . $_FILES["kk"]["name"];
    move_uploaded_file($_FILES["kk"]["tmp_name"], $path4);
    $message = '
    <h3 align="center">Permohonan Pindah Masuk</h3>
...
// ADD YOUR DETAILS HERE
    ...
    $mail->Subject = 'Permohonan Pindah Masuk';                //Sets the Subject of the message
