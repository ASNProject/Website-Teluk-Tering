...
<html lang="en">
  <head>
    ...
    <title>Permohonan Surat Keterangan Usaha</title>
  ...
  <body>
      ...
      <nav>
        <div class="container-flex">
          ...
          <ul class="sidebar">
            ...
            <li><a href="form pengaduan.php"></a></li>
          </ul>
        </div>
      </nav>
    </div>
    <div class="container" style="background-color: rgb(212, 208, 208)">
      <br />
      <h1 style="text-align: center">PERMOHONAN PEMBUATAN SURAT KETERANGAN USAHA</h1>
      <div class="row">
